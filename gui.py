...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_item.setGeometry(QtCore.QRect(550, 350, 113, 32))
        self.add_item.setObjectName("add_item")
        self.new_item_input = QtWidgets.QLineEdit(self.centralwidget)
        self.new_item_input.setGeometry(QtCore.QRect(340, 320, 321, 21))
        ...
        self.info_label.setGeometry(QtCore.QRect(350, 260, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.info_label.setFont(font)
        self.info_label.setObjectName("info_label")
        self.add_item_label = QtWidgets.QLabel(self.centralwidget)
        self.add_item_label.setGeometry(QtCore.QRect(350, 350, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.export_button.setGeometry(QtCore.QRect(612, 491, 161, 51))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.new_item_input.setPlaceholderText(_translate("MainWindow", "Add new item"))
